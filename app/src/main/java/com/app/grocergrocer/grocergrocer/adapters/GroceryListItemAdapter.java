...
public class GroceryListItemAdapter extends RecyclerView.Adapter<GroceryListItemAdapter.ViewHolder> {
    ...
    public GroceryListItemAdapter(List<Product> productList) {
    ...
    @Override
    public GroceryListItemAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_grocery_list_item, viewGroup, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final GroceryListItemAdapter.ViewHolder viewHolder, int position) {
        final Product product = mProductList.get(position);
